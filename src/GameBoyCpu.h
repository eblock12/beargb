...
public:
    ...
    inline void LD_HL(s8 val);
    inline void LD_IndirectWord(u16 addr, u16 val);
    ...
    inline void RL_Indirect(u16 addr);
    inline void RLA();
    inline void RLC(u8 &reg);
    inline void RLC_Indirect(u16 addr);
    inline void RLCA();
    inline void RR(u8 &reg);
    inline void RR_Indirect(u16 addr);
    inline void RRA();
    inline void RRC(u8 &reg);
    inline void RRC_Indirect(u16 addr);
    inline void RRCA();
    inline void RST(u8 val);
    inline void SBC(u8 val);
    inline void SLA(u8 &reg);
    inline void SLA_Indirect(u16 addr);
